...
#figure(
  {
    ...
    cetz.canvas({
      ...
      let block0_x = 0.7
      for i in range(4) {
        rect((block0_x + i * 0.85, 0.8), (block0_x + (i + 1) * 0.85 - 0.05, 1.8), fill: rgb(255, 200, 200), stroke: rgb(
          150,
          50,
          50,
        ))
      ...
      let block1_x = 5.0
      for i in range(4) {
        rect((block1_x + i * 0.85, 0.8), (block1_x + (i + 1) * 0.85 - 0.05, 1.8), fill: rgb(255, 200, 200), stroke: rgb(
          150,
          50,
          50,
        ))
      ...
      let block2_x = 9.3
      for i in range(4) {
        rect((block2_x + i * 0.85, 0.8), (block2_x + (i + 1) * 0.85 - 0.05, 1.8), fill: rgb(255, 200, 200), stroke: rgb(
          150,
          50,
          50,
        ))
